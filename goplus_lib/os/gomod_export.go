...
func execChmod(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := os.Chmod(args[0].(string), args[1].(fs.FileMode))
	p.Ret(2, ret0)
}
...
func execCreateTemp(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := os.CreateTemp(args[0].(string), args[1].(string))
	p.Ret(2, ret0, ret1)
}
...
func execDirFS(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := os.DirFS(args[0].(string))
	p.Ret(1, ret0)
}
...
func execmFileReadFrom(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := args[0].(*os.File).ReadFrom(toType0(args[1]))
	p.Ret(2, ret0, ret1)
}
...
func execmFileChmod(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*os.File).Chmod(args[1].(fs.FileMode))
	p.Ret(2, ret0)
}
...
func execIsExist(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := os.IsExist(toType1(args[0]))
	p.Ret(1, ret0)
}

func execIsNotExist(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := os.IsNotExist(toType1(args[0]))
	p.Ret(1, ret0)
}
...
func execIsPermission(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := os.IsPermission(toType1(args[0]))
	p.Ret(1, ret0)
}

func execIsTimeout(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := os.IsTimeout(toType1(args[0]))
	p.Ret(1, ret0)
}
...
func execMkdir(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := os.Mkdir(args[0].(string), args[1].(fs.FileMode))
	p.Ret(2, ret0)
}

func execMkdirAll(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := os.MkdirAll(args[0].(string), args[1].(fs.FileMode))
	p.Ret(2, ret0)
}

func execMkdirTemp(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := os.MkdirTemp(args[0].(string), args[1].(string))
	p.Ret(2, ret0, ret1)
}
...
func execNewSyscallError(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := os.NewSyscallError(args[0].(string), toType1(args[1]))
	p.Ret(2, ret0)
}
...
func execOpenFile(_ int, p *gop.Context) {
	args := p.GetArgs(3)
	ret0, ret1 := os.OpenFile(args[0].(string), args[1].(int), args[2].(fs.FileMode))
	p.Ret(3, ret0, ret1)
}
...
func toType2(v interface{}) os.Signal {
	if v == nil {
		return nil
	}
	return v.(os.Signal)
...
func execmProcessSignal(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*os.Process).Signal(toType2(args[1]))
	p.Ret(2, ret0)
}
...
func execReadDir(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := os.ReadDir(args[0].(string))
	p.Ret(1, ret0, ret1)
}

func execReadFile(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := os.ReadFile(args[0].(string))
	p.Ret(1, ret0, ret1)
}
...
func toType3(v interface{}) fs.FileInfo {
	if v == nil {
		return nil
	}
	return v.(fs.FileInfo)
}

func execSameFile(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := os.SameFile(toType3(args[0]), toType3(args[1]))
	p.Ret(2, ret0)
}
...
func execWriteFile(_ int, p *gop.Context) {
	args := p.GetArgs(3)
	ret0 := os.WriteFile(args[0].(string), args[1].([]byte), args[2].(fs.FileMode))
	p.Ret(3, ret0)
}
...
func init() {
	I.RegisterFuncs(
		...
		I.Func("CreateTemp", os.CreateTemp, execCreateTemp),
		...
		I.Func("DirFS", os.DirFS, execDirFS),
		...
		I.Func("(*File).ReadFrom", (*os.File).ReadFrom, execmFileReadFrom),
		...
		I.Func("MkdirTemp", os.MkdirTemp, execMkdirTemp),
		...
		I.Func("ReadDir", os.ReadDir, execReadDir),
		I.Func("ReadFile", os.ReadFile, execReadFile),
		...
		I.Func("WriteFile", os.WriteFile, execWriteFile),
	)
	I.RegisterVars(
		I.Var("Args", &os.Args),
		I.Var("ErrClosed", &os.ErrClosed),
		I.Var("ErrDeadlineExceeded", &os.ErrDeadlineExceeded),
		...
		I.Var("ErrProcessDone", &os.ErrProcessDone),
	...
	I.RegisterTypes(
		I.Type("DirEntry", reflect.TypeOf((*os.DirEntry)(nil)).Elem()),
