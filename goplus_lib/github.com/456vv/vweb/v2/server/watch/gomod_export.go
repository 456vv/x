// Package watch provide Go+ "github.com/456vv/vweb/v2/server/watch" package, as "github.com/456vv/vweb/v2/server/watch" package in Go.
package watch

import (
	reflect "reflect"

	watch "github.com/456vv/vweb/v2/server/watch"
...
var I = gop.NewGoPackage("github.com/456vv/vweb/v2/server/watch")
