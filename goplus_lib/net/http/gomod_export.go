...
func execFS(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := http.FS(toType2(args[0]))
	p.Ret(1, ret0)
}
...
func toType3(v interface{}) http.FileSystem {
	if v == nil {
		return nil
	}
...
func execFileServer(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := http.FileServer(toType3(args[0]))
	p.Ret(1, ret0)
}
...
func toType4(v interface{}) http.Handler {
	if v == nil {
		return nil
	}
...
func execHandle(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	http.Handle(args[0].(string), toType4(args[1]))
	p.PopN(2)
}
...
func toType5(v interface{}) io.Writer {
	if v == nil {
		return nil
	}
	return v.(io.Writer)
...
func execmHeaderWrite(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(http.Header).Write(toType5(args[1]))
	p.Ret(2, ret0)
}
...
func execmHeaderWriteSubset(_ int, p *gop.Context) {
	args := p.GetArgs(3)
	ret0 := args[0].(http.Header).WriteSubset(toType5(args[1]), args[2].(map[string]bool))
	p.Ret(3, ret0)
}
...
func execListenAndServe(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := http.ListenAndServe(args[0].(string), toType4(args[1]))
	p.Ret(2, ret0)
}

func execListenAndServeTLS(_ int, p *gop.Context) {
	args := p.GetArgs(4)
	ret0 := http.ListenAndServeTLS(args[0].(string), args[1].(string), args[2].(string), toType4(args[3]))
	p.Ret(4, ret0)
}

func toType6(v interface{}) io.ReadCloser {
	if v == nil {
		return nil
	}
...
func execMaxBytesReader(_ int, p *gop.Context) {
	args := p.GetArgs(3)
	ret0 := http.MaxBytesReader(toType1(args[0]), toType6(args[1]), args[2].(int64))
	p.Ret(3, ret0)
}

func execNewFileTransport(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := http.NewFileTransport(toType3(args[0]))
	p.Ret(1, ret0)
}
...
func toType7(v interface{}) context.Context {
	if v == nil {
		return nil
	}
...
func execNewRequestWithContext(_ int, p *gop.Context) {
	args := p.GetArgs(4)
	ret0, ret1 := http.NewRequestWithContext(toType7(args[0]), args[1].(string), args[2].(string), toType0(args[3]))
	p.Ret(4, ret0, ret1)
}
...
func execmRequestWithContext(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*http.Request).WithContext(toType7(args[1]))
	p.Ret(2, ret0)
}

func execmRequestClone(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*http.Request).Clone(toType7(args[1]))
	p.Ret(2, ret0)
}
...
func execmRequestWrite(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*http.Request).Write(toType5(args[1]))
	p.Ret(2, ret0)
}

func execmRequestWriteProxy(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*http.Request).WriteProxy(toType5(args[1]))
	p.Ret(2, ret0)
}
...
func execmResponseWrite(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*http.Response).Write(toType5(args[1]))
	p.Ret(2, ret0)
}
...
func toType8(v interface{}) net.Listener {
	if v == nil {
		return nil
	}
...
func execServe(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := http.Serve(toType8(args[0]), toType4(args[1]))
	p.Ret(2, ret0)
}

func toType9(v interface{}) io.ReadSeeker {
	if v == nil {
		return nil
	}
...
func execServeContent(_ int, p *gop.Context) {
	args := p.GetArgs(5)
	http.ServeContent(toType1(args[0]), args[1].(*http.Request), args[2].(string), args[3].(time.Time), toType9(args[4]))
	p.PopN(5)
}
...
func execmServeMuxHandle(_ int, p *gop.Context) {
	args := p.GetArgs(3)
	args[0].(*http.ServeMux).Handle(args[1].(string), toType4(args[2]))
	p.PopN(3)
}
...
func execServeTLS(_ int, p *gop.Context) {
	args := p.GetArgs(4)
	ret0 := http.ServeTLS(toType8(args[0]), toType4(args[1]), args[2].(string), args[3].(string))
	p.Ret(4, ret0)
}
...
func execmServerShutdown(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*http.Server).Shutdown(toType7(args[1]))
	p.Ret(2, ret0)
}
...
func execmServerServe(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*http.Server).Serve(toType8(args[1]))
	p.Ret(2, ret0)
}

func execmServerServeTLS(_ int, p *gop.Context) {
	args := p.GetArgs(4)
	ret0 := args[0].(*http.Server).ServeTLS(toType8(args[1]), args[2].(string), args[3].(string))
	p.Ret(4, ret0)
}
...
func execStripPrefix(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := http.StripPrefix(args[0].(string), toType4(args[1]))
	p.Ret(2, ret0)
}

func execTimeoutHandler(_ int, p *gop.Context) {
	args := p.GetArgs(3)
	ret0 := http.TimeoutHandler(toType4(args[0]), args[1].(time.Duration), args[2].(string))
	p.Ret(3, ret0)
}
...
func toType10(v interface{}) http.RoundTripper {
	if v == nil {
		return nil
	}
...
func execmTransportRegisterProtocol(_ int, p *gop.Context) {
	args := p.GetArgs(3)
	args[0].(*http.Transport).RegisterProtocol(args[1].(string), toType10(args[2]))
	p.PopN(3)
}
