...
func toType1(v interface{}) crypto.Signer {
	if v == nil {
		return nil
	}
...
func execCreateRevocationList(_ int, p *gop.Context) {
	args := p.GetArgs(4)
	ret0, ret1 := x509.CreateRevocationList(toType0(args[0]), args[1].(*x509.RevocationList), args[2].(*x509.Certificate), toType1(args[3]))
	p.Ret(4, ret0, ret1)
}
...
func execmSystemRootsErrorUnwrap(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(x509.SystemRootsError).Unwrap()
	p.Ret(1, ret0)
}
...
func init() {
	I.RegisterFuncs(
		...
		I.Func("CreateRevocationList", x509.CreateRevocationList, execCreateRevocationList),
		...
		I.Func("(SystemRootsError).Unwrap", (x509.SystemRootsError).Unwrap, execmSystemRootsErrorUnwrap),
	...
	I.RegisterTypes(
		...
		I.Type("RevocationList", reflect.TypeOf((*x509.RevocationList)(nil)).Elem()),
