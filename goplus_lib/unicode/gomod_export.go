...
func init() {
	...
	I.RegisterVars(
		...
		I.Var("Chorasmian", &unicode.Chorasmian),
		I.Var("Co", &unicode.Co),
		...
		I.Var("Dives_Akuru", &unicode.Dives_Akuru),
		...
		I.Var("Khitan_Small_Script", &unicode.Khitan_Small_Script),
