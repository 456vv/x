...
func execmClientAuthTypeString(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(tls.ClientAuthType).String()
	p.Ret(1, ret0)
}
...
func execmCurveIDString(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(tls.CurveID).String()
	p.Ret(1, ret0)
}
...
func execmDialerDial(_ int, p *gop.Context) {
	args := p.GetArgs(3)
	ret0, ret1 := args[0].(*tls.Dialer).Dial(args[1].(string), args[2].(string))
	p.Ret(3, ret0, ret1)
}
...
func execmDialerDialContext(_ int, p *gop.Context) {
	args := p.GetArgs(4)
	ret0, ret1 := args[0].(*tls.Dialer).DialContext(toType1(args[1]), args[2].(string), args[3].(string))
	p.Ret(4, ret0, ret1)
}
...
func toType2(v interface{}) net.Listener {
	if v == nil {
		return nil
	}
...
func execNewListener(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0 := tls.NewListener(toType2(args[0]), args[1].(*tls.Config))
	p.Ret(2, ret0)
}
...
func execmSignatureSchemeString(_ int, p *gop.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(tls.SignatureScheme).String()
	p.Ret(1, ret0)
}
...
func init() {
	I.RegisterFuncs(
		...
		I.Func("(ClientAuthType).String", (tls.ClientAuthType).String, execmClientAuthTypeString),
		...
		I.Func("(CurveID).String", (tls.CurveID).String, execmCurveIDString),
		I.Func("Dial", tls.Dial, execDial),
		I.Func("DialWithDialer", tls.DialWithDialer, execDialWithDialer),
		I.Func("(*Dialer).Dial", (*tls.Dialer).Dial, execmDialerDial),
		I.Func("(*Dialer).DialContext", (*tls.Dialer).DialContext, execmDialerDialContext),
		...
		I.Func("(SignatureScheme).String", (tls.SignatureScheme).String, execmSignatureSchemeString),
	...
	I.RegisterTypes(
		...
		I.Type("Dialer", reflect.TypeOf((*tls.Dialer)(nil)).Elem()),
