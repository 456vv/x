...
func init() {
	igop.RegisterPackage(&igop.Package{
		...
		NamedTypes: map[string]igop.NamedType{
			...
			"Request":              {reflect.TypeOf((*q.Request)(nil)).Elem(), "", "Config,Context,GetBasicAuth,GetBody,GetNonce,GetTokenAuth,Marshal,ProtoAtLeast,SetBasicAuth,SetBody,SetTokenAuth,WithContext,wantsClose"},
			"RequestConfig":        {reflect.TypeOf((*q.RequestConfig)(nil)).Elem(), "", "GetBody,Marshal,SetBody,Unmarshal"},
			"Response":             {reflect.TypeOf((*q.Response)(nil)).Elem(), "", "Config,Marshal,SetNonce,WriteAt,WriteTo"},
			...
			"Server":               {reflect.TypeOf((*q.Server)(nil)).Elem(), "", "Close,ListenAndServe,RegisterOnShutdown,Serve,ServeTLS,SetKeepAlivesEnabled,Shutdown,closeConns,closeDoneChan,closeIdleConns,closeListeners,doKeepAlives,idleTimeout,init,logf,maxLineBytes,shuttingDown,trackConn,trackListener"},
