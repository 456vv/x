...
return  map[string]template.FuncMap{
	"vweb":{
		...
		"ExecCall":func(a ...interface{}) (retn *vweb.ExecCall) {builtin.GoTypeTo(&retn)(a...);return retn},
		"ExitCall":func(a ...interface{}) (retn *vweb.ExitCall) {builtin.GoTypeTo(&retn)(a...);return retn},
