...
func execmResolverLookupIP(_ int, p *gop.Context) {
	args := p.GetArgs(4)
	ret0, ret1 := args[0].(*net.Resolver).LookupIP(toType1(args[1]), args[2].(string), args[3].(string))
	p.Ret(4, ret0, ret1)
}
...
func init() {
	I.RegisterFuncs(
		...
		I.Func("(*Resolver).LookupIP", (*net.Resolver).LookupIP, execmResolverLookupIP),
