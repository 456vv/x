...
func execMarshalCompressed(_ int, p *gop.Context) {
	args := p.GetArgs(3)
	ret0 := elliptic.MarshalCompressed(toType0(args[0]), args[1].(*big.Int), args[2].(*big.Int))
	p.Ret(3, ret0)
}
...
func execUnmarshalCompressed(_ int, p *gop.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := elliptic.UnmarshalCompressed(toType0(args[0]), args[1].([]byte))
	p.Ret(2, ret0, ret1)
}
...
func init() {
	I.RegisterFuncs(
		...
		I.Func("MarshalCompressed", elliptic.MarshalCompressed, execMarshalCompressed),
		...
		I.Func("UnmarshalCompressed", elliptic.UnmarshalCompressed, execUnmarshalCompressed),
	)
	I.RegisterTypes(
